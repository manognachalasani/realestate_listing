...
const seed = async () => {
  ...
  const agents = await User.insertMany([
    {
      ...
      email: 'sarah@estatehub.com', password: hashedPw, role: 'agent', phone: '555-0101',
      agentProfile: {
        licenseNumber: 'RE-001-2019', agency: 'EstateHub Realty',
        bio: 'Specializing in luxury homes and waterfront properties for 10+ years.',
        specializations: ['Luxury', 'Waterfront', 'Investment'],
        yearsOfExperience: 10, verified: true, rating: 4.9, reviewCount: 87,
      },
    },
    {
      firstName: 'James', lastName: 'Thornton',
      email: 'james@estatehub.com', password: hashedPw, role: 'agent', phone: '555-0102',
      agentProfile: {
        licenseNumber: 'RE-002-2020', agency: 'Prime Properties',
        ...
        yearsOfExperience: 6, verified: true, rating: 4.7, reviewCount: 52,
      },
    },
  ]);
  ...
  await User.create({
    ...
    email: 'emma@example.com', password: hashedPw, role: 'buyer', phone: '555-0201',
  });
  ...
  const propertyData = [
    {
      ...
      propertyType: 'villa', listingType: 'sale', price: 2850000,
      bedrooms: 5, bathrooms: 4, garages: 2, area: 4200, yearBuilt: 2020, floors: 2,
      furnished: 'fully-furnished',
      address: { street: '1 Ocean Drive', city: 'Malibu', state: 'CA', zipCode: '90265', country: 'USA' },
      ...
      agent: agents[0]._id, status: 'active',
    },
    {
      ...
      propertyType: 'apartment', listingType: 'sale', price: 4500000,
      bedrooms: 3, bathrooms: 3, garages: 2, area: 3100, yearBuilt: 2018,
      furnished: 'fully-furnished',
      address: { street: '432 Park Avenue, PH', city: 'New York', state: 'NY', zipCode: '10022', country: 'USA' },
      location: { type: 'Point', coordinates: [-73.9713, 40.7614] },
      neighborhood: 'Midtown East',
      amenities: ['Concierge', 'Rooftop Terrace', 'Gym', 'Spa', 'Valet Parking', 'City Views'],
      photos: [
    ...
    },
    {
      ...
      propertyType: 'house', listingType: 'sale', price: 895000,
      bedrooms: 3, bathrooms: 2, garages: 1, area: 1850, yearBuilt: 1924, floors: 1,
      furnished: 'unfurnished',
      address: { street: '742 Maple Street', city: 'Pasadena', state: 'CA', zipCode: '91101', country: 'USA' },
      ...
      agent: agents[1]._id, status: 'active',
    },
    {
      ...
      propertyType: 'apartment', listingType: 'rent', price: 3800,
      bedrooms: 2, bathrooms: 2, garages: 1, area: 1100, yearBuilt: 2021,
      furnished: 'semi-furnished',
      address: { street: '55 West Loop Drive', city: 'Chicago', state: 'IL', zipCode: '60601', country: 'USA' },
      location: { type: 'Point', coordinates: [-87.6298, 41.8827] },
    ...
    },
    {
      ...
      propertyType: 'house', listingType: 'sale', price: 1250000,
      bedrooms: 4, bathrooms: 3, garages: 2, area: 3200, yearBuilt: 1998, floors: 2,
      furnished: 'unfurnished',
      address: { street: '88 Lakeview Lane', city: 'Lake Geneva', state: 'WI', zipCode: '53147', country: 'USA' },
      location: { type: 'Point', coordinates: [-88.4334, 42.5917] },
    ...
    },
    {
      ...
      propertyType: 'townhouse', listingType: 'sale', price: 780000,
      bedrooms: 3, bathrooms: 2, garages: 1, area: 2000, yearBuilt: 2022, floors: 3,
      furnished: 'unfurnished',
      address: { street: '22 Beacon Street', city: 'Boston', state: 'MA', zipCode: '02108', country: 'USA' },
      location: { type: 'Point', coordinates: [-71.0699, 42.3576] },
  ...
  console.log(`✅ Seeded: ${agents.length} agents, 1 buyer, ${properties.length} properties`);
  console.log('📧 Login credentials: email@estatehub.com / password123');
  process.exit(0);
};
